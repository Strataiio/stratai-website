...
export const metadata = {
  alternates: { canonical: 'https://stratai.io/case-studies' }, title: 'Case Studies — StratAI' }
    ...
    <div style={{background:'var(--bg)',minHeight:'100vh'}}>
      <div style={{borderBottom:'1px solid var(--border)',padding:'80px 24px 56px',background:'var(--bg2)'}}>
        <div style={{maxWidth:'1280px',margin:'0 auto'}}>
          ...
          <h1 style={{fontFamily:'var(--font-display)',fontSize:'clamp(36px,6vw,76px)',fontWeight:600,letterSpacing:'-0.04em',lineHeight:1.0,color:'var(--text)',marginBottom:'18px'}}>WORK THAT<br/>SHIPPED.</h1>
          <p style={{color:'var(--text2)',fontSize:'17px',maxWidth:'440px',lineHeight:'1.65'}}>Real AI systems. Real businesses. Outcomes we can measure.</p>
        </div>
      </div>
