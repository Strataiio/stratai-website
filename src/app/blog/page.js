...
export const metadata = { title: 'Blog — StratAI' }
    ...
    <div style={{ background:'var(--bg)', minHeight:'100vh' }}>
      <div className="dot-grid" style={{ background:'var(--bg2)', borderBottom:'1px solid var(--border)', padding:'72px 24px 48px' }}>
        <div style={{ maxWidth:'1280px', margin:'0 auto' }}>
          ...
          <h1 style={{ fontFamily:'var(--font-display)', fontSize:'clamp(36px,6vw,72px)', fontWeight:600, letterSpacing:'-0.04em', lineHeight:1.0, marginBottom:'16px', color:'var(--text)' }}>FIELD NOTES.</h1>
          <p style={{ color:'var(--text2)', fontSize:'17px', maxWidth:'440px', lineHeight:'1.6' }}>Dispatch from the frontier of AI transformation — real deployments, no fluff.</p>
        </div>
      </div>
