...
export async function generateMetadata() {
  try {
    ...
    return {
      title: {
        default: 'StratAI™ — Building AI Advantage Systems for Mid-Market Manufacturing',
        template: '%s | StratAI™',
      },
      description: 'StratAI builds AI Advantage Systems for mid-market manufacturing companies. Quality, Throughput, Delivery, Revenue, and Procurement Advantage — measurable in your P&L within 6 months.',
      ...
      openGraph: {
        ...
        type: 'website',
        locale: 'en_IN',
        title: 'StratAI™ — Building AI Advantage Systems for Mid-Market Manufacturing',
        description: 'We build AI Advantage Systems for mid-market manufacturers. Measurable in your P&L within 6 months.',
