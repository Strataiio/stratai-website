...
export const metadata = {
  title: 'Anthropic Claude Partner Network Member — StratAI™',
  description: 'StratAI is an official Anthropic Claude Partner Network Member — one of the first in India. We hold 10+ Claude-certified practitioners, 2+ production deployments, and client-endorsed outcomes in manufacturing AI.',
  alternates: { canonical: 'https://stratai.io/claude-partner' },
  keywords: [
    'anthropic claude registered partner india', 'claude partner network india',
    'anthropic certified partner coimbatore', 'claude implementation partner india',
    'claude AI manufacturing india', 'claude registered partner manufacturing',
    'anthropic claude consulting india', 'claude AI partner india',
    'claude partner network services track', 'anthropic partner india',
  ],
  openGraph: {
    title: 'StratAI — Official Anthropic Claude Partner Network Member',
    description: 'One of the first Anthropic Claude Partner Network Members in India. 10+ certified practitioners. 2+ production deployments. Client-endorsed outcomes in manufacturing AI.',
      ...
      <div style={{ background: 'var(--bg-dark)', padding: 'clamp(56px,7vw,96px) clamp(16px,4vw,24px) clamp(48px,6vw,80px)', borderBottom: '1px solid #1f1f1e', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: '1100px', margin: '0 auto', position: 'relative', zIndex: 1, textAlign: 'center' }}>
          ...
          <p style={{ fontSize: 'clamp(15px,2vw,18px)', color: 'rgba(255,255,255,0.6)', maxWidth: '620px', margin: '0 auto 40px', lineHeight: '1.7' }}>
            An official member of the Anthropic Claude Partner Network — one of the first in India. Certified expertise. Production deployments. Client-endorsed outcomes. Building toward Select tier.
          </p>
      ...
      <div style={{ borderBottom: '1px solid var(--border)' }}>
        <div style={{ maxWidth: '1280px', margin: '0 auto', padding: 'clamp(40px,6vw,72px) clamp(16px,4vw,24px)' }}>
          ...
          <h2 style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(24px,4vw,44px)', fontWeight: 600, letterSpacing: '-0.04em', color: 'var(--text)', marginBottom: '16px', lineHeight: 1.05 }}>
            Official member of the Anthropic Claude Partner Network.
          </h2>
      ...
      <div style={{ background: 'var(--bg2)', borderBottom: '1px solid var(--border)' }}>
        <div style={{ maxWidth: '1280px', margin: '0 auto', padding: 'clamp(40px,6vw,72px) clamp(16px,4vw,24px)' }}>
          ...
          <h2 style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(24px,4vw,44px)', fontWeight: 600, letterSpacing: '-0.04em', color: 'var(--text)', marginBottom: '12px', lineHeight: 1.05 }}>
            Both in production. Both in the P&L.
          </h2>
      ...
      <div style={{ borderBottom: '1px solid var(--border)' }}>
        <div style={{ maxWidth: '1280px', margin: '0 auto', padding: 'clamp(40px,6vw,72px) clamp(16px,4vw,24px)' }}>
          ...
          <h2 style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(24px,4vw,44px)', fontWeight: 600, letterSpacing: '-0.04em', color: 'var(--text)', marginBottom: '40px', lineHeight: 1.05 }}>
            Why the Select tier matters when you are evaluating an AI partner.
          </h2>
