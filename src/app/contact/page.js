...
export const metadata = {
  ...
  title: 'Contact StratAI — Talk AI Advantage for Your Manufacturing Business',
  description: 'Get in touch with StratAI. We build AI Advantage Systems for mid-market manufacturing. Free half-day audit — no commitment. Coimbatore, India.',
}
      ...
      <div style={{ borderBottom: '1px solid var(--border)', padding: 'clamp(48px,6vw,80px) clamp(16px,4vw,24px) 0', background: 'var(--bg)' }}>
        <div style={{ maxWidth: '1280px', margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 'clamp(32px,5vw,80px)', alignItems: 'start' }} className="contact-grid">
          ...
          <div style={{ paddingBottom: '72px' }}>
            ...
            <h1 style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(36px,5vw,68px)', fontWeight: 600, letterSpacing: '-0.04em', lineHeight: 1.0, color: 'var(--text)', marginBottom: '18px' }}>LET&apos;S TALK AI.</h1>
            <p style={{ fontSize: '17px', color: 'var(--text2)', lineHeight: '1.7', marginBottom: '36px', maxWidth: '400px' }}>
              Tell us about your business and the transformation you are aiming for. We respond within 24 hours.
            </p>
