...
const SERVICES_4 = [
  ...
  { icon: '🔧', title: 'AI Technical Configuration',   desc: 'Build, configure, and integrate AI into your existing stack' },
  { icon: '🚀', title: 'AI Implementation',             desc: 'Deploy, adopt, and measure — until it shows in your P&L' },
]
      ...
      <section style={{ background: 'var(--bg2)', borderBottom: '1px solid var(--border)' }}>
        <div style={{ maxWidth: '1280px', margin: '0 auto', padding: 'clamp(40px,6vw,72px) clamp(16px,4vw,24px)' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '1px', background: 'var(--border)' }} className="engagement-3-grid">
            {[
              { step: '01', label: 'Free Half-Day Audit',      desc: 'We spend half a day with your team. No fee. No commitment. We identify 3–5 high-value AI use cases.' },
